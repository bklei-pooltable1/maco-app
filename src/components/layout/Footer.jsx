        ...
        <div className="footer-grid" style={{ display: "grid", gridTemplateColumns: "1.6fr 1fr 1fr 1fr", gap: 32, marginBottom: 36 }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              <div className="footer-contact-item" style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 13, color: "rgba(255,255,255,0.4)", fontFamily: body }}><MapPinIcon/> 142 James Street, New Farm, Brisbane, QLD</div>
              <div className="footer-contact-item" style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 13, color: "rgba(255,255,255,0.4)", fontFamily: body }}><MailIcon/> MacedonianCommunityOfBrisbane@gmail.com</div>
            </div>
          </div>
        </div>
        <div style={{
